...
final class Viewing_Records {
    ...
    public static function maybe_add_detail_edit_modal() {
        ...
        echo '    }';
        echo '  });';
        echo '  // 表单提交 - 如果还没有绑定，则绑定';
        echo '  if (!$("#musicalbum-manual-form").data("bound")) {';
        echo '    $("#musicalbum-manual-form").on("submit", function(e) {';
        echo '      e.preventDefault();';
        echo '      if (typeof saveViewing === "function") {';
        echo '        saveViewing($(this));';
        echo '      }';
        echo '    }).data("bound", true);';
        echo '  }';
        echo '  // 图片上传';
        echo '  $("#musicalbum-form-ticket-image").off("change").on("change", function() {';
